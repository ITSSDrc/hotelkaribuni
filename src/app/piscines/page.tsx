...
export default function PiscinesPage() {
  ...
  const piscinesQuery = query(piscinesCollectionRef, orderBy('name', 'asc'));

  const { data: piscines, isLoading } = useCollection(piscinesQuery);
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            {isLoading ? (
              ...
              <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                {piscines && (piscines as any[]).map((piscine: any) => (

  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="relative flex-1 flex items-center justify-center bg-background py-12 overflow-hidden">
        ...
        >
          <div 
            className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#ffc700] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
            style={{
